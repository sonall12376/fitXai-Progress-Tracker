...
class ProgressService {
    ...
    static formatAiReportRow(row) {
        ...
        return {
            ...
            progressScore: Number((_a = row.progress_score) !== null && _a !== void 0 ? _a : 75),
            confidenceScore: Number((_b = row.confidence_score) !== null && _b !== void 0 ? _b : 0.85),
     ...
     */
    static processCreateLog(userId, data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const existing = yield this.getLogByDate(userId, todayDate);
            console.log("STEP 1 DONE");
            if (existing) {
                const error = new Error("Today's metrics have already been recorded. Use PUT request to modify today's log.");
            ...
            const log = yield this.createLog(userId, Object.assign(Object.assign({}, data), { date: todayDate }));
            console.log("STEP 2 DONE");
            // Step 3
            console.log("STEP 3: Getting previous history...");
            const historyRows = yield this.getHistory(userId, 7, 0);
            ...
            const settingsRow = yield this.getSettings(userId);
            console.log("STEP 4 DONE");
            const coachPersona = (settingsRow === null || settingsRow === void 0 ? void 0 : settingsRow.coach_persona) || 'Motivational';
            // Step 5
            console.log("STEP 5: Calling Gemini...");
            const reportData = yield ai_service_1.AiService.generateReport({}, historicalLogs, data, coachPersona);
            console.log("STEP 5 DONE");
            // Step 6
            console.log("STEP 6: Storing AI report...");
            const reportRecord = yield this.storeReport(log.id, userId, reportData);
            console.log("STEP 6 DONE");
            console.log("========== CREATE LOG COMPLETED ==========");
            return {
                logId: log.id,
                date: log.log_date || todayDate,
                reportId: (reportRecord === null || reportRecord === void 0 ? void 0 : reportRecord.id) || null,
     ...
     */
    static processUpdateLog(userId, date, data) {
        return __awaiter(this, void 0, void 0, function* () {
            const existing = yield this.getLogByDate(userId, date);
            if (!existing) {
                const error = new Error("No progress log exists for the specified date to update.");
                error.statusCode = 404;
                error.code = 'LOG_NOT_FOUND';
                throw error;
            }
            // 1. Update Log in PostgreSQL
            const updatedLog = yield this.updateLog(userId, date, data);
            ...
            const reportData = yield ai_service_1.AiService.generateReport({}, historicalLogs, data, coachPersona);
            const reportRecord = yield this.storeReport(updatedLog.id, userId, reportData);
            return {
                logId: updatedLog.id,
    ...
    static storeReport(logId, userId, report) {
      ...
      RETURNING *`;
            const values = [
                logId,
                userId,
                (_a = report === null || report === void 0 ? void 0 : report.progressScore) !== null && _a !== void 0 ? _a : 75,
                (_b = report === null || report === void 0 ? void 0 : report.confidenceScore) !== null && _b !== void 0 ? _b : 0.85,
                this.serializeJsonb(report === null || report === void 0 ? void 0 : report.consistencyAnalysis),
                this.serializeJsonb(report === null || report === void 0 ? void 0 : report.workoutPerformance),
                this.serializeJsonb(report === null || report === void 0 ? void 0 : report.recoveryAnalysis),
                this.serializeJsonb(report === null || report === void 0 ? void 0 : report.injuryRisk),
                this.serializeJsonb(report === null || report === void 0 ? void 0 : report.userVulnerabilities),
                this.serializeJsonb(report === null || report === void 0 ? void 0 : report.improvementAnalysis),
                this.serializeJsonb(report === null || report === void 0 ? void 0 : report.goalProgress),
                this.serializeJsonb(report === null || report === void 0 ? void 0 : report.personalizedRecommendations),
                (report === null || report === void 0 ? void 0 : report.motivationMessage) || ''
            ];
            const result = yield (0, db_1.query)(text, values);
    ...
    `;
            ...
            return res.rows.map(row => (Object.assign(Object.assign({}, row), { report: row.report_row ? this.formatAiReportRow(row.report_row) : null })));
        });
    }
    /**
