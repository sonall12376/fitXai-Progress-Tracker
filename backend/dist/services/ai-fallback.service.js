...
class AiFallbackService {
     ...
     */
    static generateFallbackReport(inputPayload) {
        var _a, _b, _c, _d;
        const today = inputPayload.todayProgress || {};
        const history = inputPayload.previousHistory || [];
        const profile = inputPayload.userProfile || {};
        const targetPlan = profile.workoutPlan || {};
        const workoutDone = (_a = today.workoutCompleted) !== null && _a !== void 0 ? _a : false;
        ...
        const pain = ((_b = today.injury) === null || _b === void 0 ? void 0 : _b.painLevel) || 0;
        const hasInjury = ((_c = today.injury) === null || _c === void 0 ? void 0 : _c.hasInjury) || false;
        ...
        if (sleepQuality === 'Good' && hydrationStatus === 'Optimal')
            recoveryStatus = 'Optimal';
        else if (sleepQuality === 'Poor' || hydrationStatus === 'Critical')
        ...
        if (hasInjury || pain >= 4) {
            ...
            if ((_d = today.injury) === null || _d === void 0 ? void 0 : _d.details)
                criticalAreas.push(today.injury.details);
