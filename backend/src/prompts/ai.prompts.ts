import { CoachPersona, AiInputPayload } from '../types/ai.types';
...
export class AiPrompts {
   ...
   */
  static getPersonaStyle(persona: CoachPersona = 'Motivational'): string {
    const personaStyle: Record<CoachPersona, string> = {
   ...
   */
  static getSafetyInstructions(): string {
    return `
...
`.trim();
   ...
   */
  static getColdStartHeuristics(): string {
    return `
...
`.trim();
  ...
  persona: CoachPersona = "Motivational"
): string {
  return `
...
`;
   ...
   */
  static getUserPrompt(payload: AiInputPayload): string {
  return `
